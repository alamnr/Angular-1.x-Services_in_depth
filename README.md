# Angular-1.x Services in depth
This repo's code is written by following the Angular-1.x Services in depth youtube video tutorials which are created by Sir Koushik Kathagal (Youtube Channel:Java Brain). 
